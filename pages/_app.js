...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollYData > 100) { // 스크롤이 50px 이상 내려갔을 때
        setIsScrolled(true);
      } else {
        setIsScrolled(false);
      }
  ...
  // useEffect 를 쓰는 경우는 여러가지가 있는데 우리는 부수효과를 처리할때 사용함
  // 스크롤 위치에 따라 클래스를 추가하거나 제거하는 것이 이러한 부수 효과에 해당
  ...
  return (
    <>
      ...
      <header className={isScrolled ? "header_area scroll" : "header_area"}>
        {/* 기존 헤더 클래스명만 출력할건지 scroll 클래스명까지 같이 클릭할건지 */}
        <div className="top">
          {/* <div className="logo">
          ...
          <div className="user_box">
            <div className="user_nav mypage">
              <div className="user_icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="black" class="css-19xi8mz">
                  <g id="weight=bold, fill=true"><g id="vector"><path fill-rule="evenodd" clip-rule="evenodd" d="M12.9999 3.25V2.25H10.9999V3.25V8.25V9.25H12.9999V8.25V3.25Z" fill="black"></path><path d="M20.9999 21.75H2.99994V11.9992C2.99994 11.3045 3.56393 10.75 4.24994 10.75H19.7499C20.4403 10.75 20.9999 11.3096 20.9999 12V21.75Z" fill="black"></path></g></g>
                </svg>
              </div>
            ...
            <div className="user_nav login">
              <div className="user_icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="black" class="css-19xi8mz">
                  <g id="weight=bold, fill=true"><path id="vector" fill-rule="evenodd" clip-rule="evenodd" d="M8 10H19.25C19.6642 10 20 10.3358 20 10.75V21.25C20 21.6642 19.6642 22 19.25 22H4.75C4.33579 22 4 21.6642 4 21.25V10.75C4 10.3358 4.33579 10 4.75 10H6V8C6 4.68629 8.68629 2 12 2C13.9985 2 15.7688 2.97712 16.8593 4.47969L15.307 5.749C14.5869 4.69318 13.3744 4 12 4C9.79086 4 8 5.79086 8 8V10ZM12 12.5C12.5523 12.5 13 12.9477 13 13.5V15.5C13 16.0523 12.5523 16.5 12 16.5C11.4477 16.5 11 16.0523 11 15.5V13.5C11 12.9477 11.4477 12.5 12 12.5Z" fill="black"></path></g>
                </svg>
              </div>
        ...
        <div className="center">
          ...
          <a href="#none" className="search">
            <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" color="black" class="css-14za774">
              <g id="weight=bold, fill=true"><path id="vector" fill-rule="evenodd" clip-rule="evenodd" d="M10.9 4.5C7.36538 4.5 4.5 7.36538 4.5 10.9C4.5 14.4346 7.36538 17.3 10.9 17.3C12.6636 17.3 14.2589 16.588 15.4175 15.4334C16.5815 14.2735 17.3 12.6716 17.3 10.9C17.3 7.36538 14.4346 4.5 10.9 4.5ZM2.5 10.9C2.5 6.26081 6.26081 2.5 10.9 2.5C15.5392 2.5 19.3 6.26081 19.3 10.9C19.3 12.8628 18.6258 14.6695 17.4979 16.0993L21.2056 19.7914L19.7944 21.2086L16.0818 17.5116C14.6548 18.6313 12.8548 19.3 10.9 19.3C6.26081 19.3 2.5 15.5392 2.5 10.9Z" fill="black"></path></g>
            </svg>
          </a>
        </div>
      ...
      <footer className="mt-[150px] border-t border-[#dbdbdb]">
        <div className="flex flex-col gap-[30px] py-[24px] px-[56px] w-[100%]">
          <div className="flex flex-col gap-[8px]">
            <p className="text-[20px] font-[700]">고객센터 1644-0560</p>
            <div className="text-[16px] text-[#a2a2a2] font-[700]">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-[12px]">
              <a
                className="flex items-center justify-between rounded-[4px] px-[12px] py-[6px] text-[20px] bg-[#000] text-[#fff] font-[700]"
                href="#none"
              >
                FAQ
              </a>
            ...
            <div className="flex gap-[24px]">
              <a
                className="flex h-[30px] w-[30px] items-center justify-center rounded-[50%] bg-[#000]" href="#none">
                <svg
              ...
              <a
                ...
                >
                  <circle cx="15" cy="15" r="15" fill="#000"></circle>
                  <g clipPath="url(#clip0_10313_20772)">
                    <path
                      fill="#747474"
                      d="M15.634 15.054l-5.83 6.26a1.58 1.58 0 001.524 1.18c.29 0 .564-.077.8-.221l.016-.011 6.563-3.829-3.073-3.385v.006z"
                    ></path>
                    <path
                      fill="#BBB"
                      d="M21.54 13.99h-.006l-2.832-1.668-3.194 2.876 3.205 3.24 2.82-1.645a1.6 1.6 0 00.828-1.401 1.577 1.577 0 00-.82-1.397v-.005z"
                    ></path>
                    <path
                      fill="#919191"
                      d="M9.805 9.436a1.68 1.68 0 00-.055.41v11.058c0 .144.016.277.055.41l6.031-6.1-6.031-5.778z"
                    ></path>
                    <path
                      fill="#7C7C7C"
                      d="M15.677 15.375l3.02-3.053-6.559-3.845a1.56 1.56 0 00-.816-.227 1.58 1.58 0 00-1.517 1.18l5.872 5.945z"
                    ></path>
                  </g>
                  <defs>
                    <clipPath id="clip0_10313_20772">
                      <path
                        fill="#fff"
                        d="M0 0H12.606V14.25H0z"
